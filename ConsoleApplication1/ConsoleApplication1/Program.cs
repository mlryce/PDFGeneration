    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var db = new StudentContext())
            {
                ...
                XgraphicTest.DrawString("Student Name: " + student.student_first_name + " " + student.student_last_name, studentFont, XBrushes.Black, new XRect(60, 90, 0, 0), XStringFormats.Default);
